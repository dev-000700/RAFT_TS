...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='GOOG.csv', help='data file')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_topm{}_{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_dt{}_{}_{}'.format(
                args.data_path,
                args.topm,
                args.data,
                args.seq_len,
